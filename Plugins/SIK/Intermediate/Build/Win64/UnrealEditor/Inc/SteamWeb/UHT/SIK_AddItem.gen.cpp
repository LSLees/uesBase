...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USIK_AddItem_AddItem_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USIK_AddItem, nullptr, "AddItem", 	Z_Construct_UFunction_USIK_AddItem_AddItem_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USIK_AddItem_AddItem_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USIK_AddItem_AddItem_Statics::SIK_AddItem_eventAddItem_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USIK_AddItem_AddItem_Statics::Function_MetaDataParams), Z_Construct_UFunction_USIK_AddItem_AddItem_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_USIK_AddItem;
UClass* USIK_AddItem::GetPrivateStaticClass()
{
	using TClass = USIK_AddItem;
	if (!Z_Registration_Info_UClass_USIK_AddItem.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("SIK_AddItem"),
			Z_Registration_Info_UClass_USIK_AddItem.InnerSingleton,
			StaticRegisterNativesUSIK_AddItem,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_USIK_AddItem.InnerSingleton;
}
UClass* Z_Construct_UClass_USIK_AddItem_NoRegister()
{
	return USIK_AddItem::GetPrivateStaticClass();
}
...
// ********** Begin Class USIK_AddItem constinit property declarations *****************************
// ********** End Class USIK_AddItem constinit property declarations *******************************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("AddItem"), .Pointer = &USIK_AddItem::execAddItem },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USIK_AddItem_AddItem, "AddItem" }, // 3928093112
	};
...
void USIK_AddItem::StaticRegisterNativesUSIK_AddItem()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_USIK_AddItem_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, USIK_AddItem);
USIK_AddItem::~USIK_AddItem() {}
// ********** End Class USIK_AddItem ***************************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_Inventory_SIK_AddItem_h__Script_SteamWeb_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USIK_AddItem, USIK_AddItem::StaticClass, TEXT("USIK_AddItem"), &Z_Registration_Info_UClass_USIK_AddItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USIK_AddItem), 2633579383U) },
	};
}; // Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_Inventory_SIK_AddItem_h__Script_SteamWeb_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_Inventory_SIK_AddItem_h__Script_SteamWeb_2118362649{
	TEXT("/Script/SteamWeb"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_Inventory_SIK_AddItem_h__Script_SteamWeb_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_Inventory_SIK_AddItem_h__Script_SteamWeb_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
