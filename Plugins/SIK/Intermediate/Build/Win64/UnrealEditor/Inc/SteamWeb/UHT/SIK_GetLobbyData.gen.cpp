...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USIK_GetLobbyData_GetLobbyData_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USIK_GetLobbyData, nullptr, "GetLobbyData", 	Z_Construct_UFunction_USIK_GetLobbyData_GetLobbyData_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USIK_GetLobbyData_GetLobbyData_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USIK_GetLobbyData_GetLobbyData_Statics::SIK_GetLobbyData_eventGetLobbyData_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USIK_GetLobbyData_GetLobbyData_Statics::Function_MetaDataParams), Z_Construct_UFunction_USIK_GetLobbyData_GetLobbyData_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_USIK_GetLobbyData;
UClass* USIK_GetLobbyData::GetPrivateStaticClass()
{
	using TClass = USIK_GetLobbyData;
	if (!Z_Registration_Info_UClass_USIK_GetLobbyData.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("SIK_GetLobbyData"),
			Z_Registration_Info_UClass_USIK_GetLobbyData.InnerSingleton,
			StaticRegisterNativesUSIK_GetLobbyData,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_USIK_GetLobbyData.InnerSingleton;
}
UClass* Z_Construct_UClass_USIK_GetLobbyData_NoRegister()
{
	return USIK_GetLobbyData::GetPrivateStaticClass();
}
...
// ********** Begin Class USIK_GetLobbyData constinit property declarations ************************
// ********** End Class USIK_GetLobbyData constinit property declarations **************************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("GetLobbyData"), .Pointer = &USIK_GetLobbyData::execGetLobbyData },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USIK_GetLobbyData_GetLobbyData, "GetLobbyData" }, // 2804084937
	};
...
void USIK_GetLobbyData::StaticRegisterNativesUSIK_GetLobbyData()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_USIK_GetLobbyData_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, USIK_GetLobbyData);
USIK_GetLobbyData::~USIK_GetLobbyData() {}
// ********** End Class USIK_GetLobbyData **********************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_LobbyMatchmaking_SIK_GetLobbyData_h__Script_SteamWeb_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USIK_GetLobbyData, USIK_GetLobbyData::StaticClass, TEXT("USIK_GetLobbyData"), &Z_Registration_Info_UClass_USIK_GetLobbyData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USIK_GetLobbyData), 2604655074U) },
	};
}; // Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_LobbyMatchmaking_SIK_GetLobbyData_h__Script_SteamWeb_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_LobbyMatchmaking_SIK_GetLobbyData_h__Script_SteamWeb_77514847{
	TEXT("/Script/SteamWeb"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_LobbyMatchmaking_SIK_GetLobbyData_h__Script_SteamWeb_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamWeb_Functions_LobbyMatchmaking_SIK_GetLobbyData_h__Script_SteamWeb_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
