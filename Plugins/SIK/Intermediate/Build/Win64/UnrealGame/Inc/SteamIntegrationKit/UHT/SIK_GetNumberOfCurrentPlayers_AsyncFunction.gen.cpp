...
// ********** Begin Delegate FOnNumberOfCurrentPlayersReceived constinit property declarations *****
	static const UECodeGen_Private::FIntPropertyParams NewProp_NumberOfCurrentPlayers;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Delegate FOnNumberOfCurrentPlayersReceived constinit property declarations *******
	static const UECodeGen_Private::FDelegateFunctionParams FuncParams;
};

// ********** Begin Delegate FOnNumberOfCurrentPlayersReceived Property Definitions ****************
...
// ********** End Delegate FOnNumberOfCurrentPlayersReceived Property Definitions ******************
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_SteamIntegrationKit_OnNumberOfCurrentPlayersReceived__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_SteamIntegrationKit, nullptr, "OnNumberOfCurrentPlayersReceived__DelegateSignature", 	Z_Construct_UDelegateFunction_SteamIntegrationKit_OnNumberOfCurrentPlayersReceived__DelegateSignature_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SteamIntegrationKit_OnNumberOfCurrentPlayersReceived__DelegateSignature_Statics::PropPointers), 
sizeof(Z_Construct_UDelegateFunction_SteamIntegrationKit_OnNumberOfCurrentPlayersReceived__DelegateSignature_Statics::_Script_SteamIntegrationKit_eventOnNumberOfCurrentPlayersReceived_Parms),
...
UFunction* Z_Construct_UDelegateFunction_SteamIntegrationKit_OnNumberOfCurrentPlayersReceived__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_SteamIntegrationKit_OnNumberOfCurrentPlayersReceived__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USIK_GetNumberOfCurrentPlayers_AsyncFunction_GetNumberOfCurrentPlayers_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USIK_GetNumberOfCurrentPlayers_AsyncFunction, nullptr, "GetNumberOfCurrentPlayers", 	Z_Construct_UFunction_USIK_GetNumberOfCurrentPlayers_AsyncFunction_GetNumberOfCurrentPlayers_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USIK_GetNumberOfCurrentPlayers_AsyncFunction_GetNumberOfCurrentPlayers_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USIK_GetNumberOfCurrentPlayers_AsyncFunction_GetNumberOfCurrentPlayers_Statics::SIK_GetNumberOfCurrentPlayers_AsyncFunction_eventGetNumberOfCurrentPlayers_Parms),
...
FClassRegistrationInfo Z_Registration_Info_UClass_USIK_GetNumberOfCurrentPlayers_AsyncFunction;
UClass* USIK_GetNumberOfCurrentPlayers_AsyncFunction::GetPrivateStaticClass()
{
	using TClass = USIK_GetNumberOfCurrentPlayers_AsyncFunction;
	if (!Z_Registration_Info_UClass_USIK_GetNumberOfCurrentPlayers_AsyncFunction.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("SIK_GetNumberOfCurrentPlayers_AsyncFunction"),
			Z_Registration_Info_UClass_USIK_GetNumberOfCurrentPlayers_AsyncFunction.InnerSingleton,
			StaticRegisterNativesUSIK_GetNumberOfCurrentPlayers_AsyncFunction,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_USIK_GetNumberOfCurrentPlayers_AsyncFunction.InnerSingleton;
}
UClass* Z_Construct_UClass_USIK_GetNumberOfCurrentPlayers_AsyncFunction_NoRegister()
{
	return USIK_GetNumberOfCurrentPlayers_AsyncFunction::GetPrivateStaticClass();
}
...
// ********** Begin Class USIK_GetNumberOfCurrentPlayers_AsyncFunction constinit property declarations 
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnSuccess;
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnFailure;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class USIK_GetNumberOfCurrentPlayers_AsyncFunction constinit property declarations 
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("GetNumberOfCurrentPlayers"), .Pointer = &USIK_GetNumberOfCurrentPlayers_AsyncFunction::execGetNumberOfCurrentPlayers },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USIK_GetNumberOfCurrentPlayers_AsyncFunction_GetNumberOfCurrentPlayers, "GetNumberOfCurrentPlayers" }, // 2540881096
	};
...
// ********** End Class USIK_GetNumberOfCurrentPlayers_AsyncFunction Property Definitions **********
...
void USIK_GetNumberOfCurrentPlayers_AsyncFunction::StaticRegisterNativesUSIK_GetNumberOfCurrentPlayers_AsyncFunction()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_USIK_GetNumberOfCurrentPlayers_AsyncFunction_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, USIK_GetNumberOfCurrentPlayers_AsyncFunction);
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamIntegrationKit_Functions_UserStats_SIK_GetNumberOfCurrentPlayers_AsyncFunction_h__Script_SteamIntegrationKit_Statics
{
...
}; // Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamIntegrationKit_Functions_UserStats_SIK_GetNumberOfCurrentPlayers_AsyncFunction_h__Script_SteamIntegrationKit_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamIntegrationKit_Functions_UserStats_SIK_GetNumberOfCurrentPlayers_AsyncFunction_h__Script_SteamIntegrationKit_3766453577{
	TEXT("/Script/SteamIntegrationKit"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamIntegrationKit_Functions_UserStats_SIK_GetNumberOfCurrentPlayers_AsyncFunction_h__Script_SteamIntegrationKit_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamIntegrationKit_Source_SteamIntegrationKit_Functions_UserStats_SIK_GetNumberOfCurrentPlayers_AsyncFunction_h__Script_SteamIntegrationKit_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
